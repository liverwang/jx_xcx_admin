...
Dialog.prototype = {
    ...
    createOverlay : function(){
        ...
        style.cssText = 'margin:0;padding:0;border:none;width:100%;height:100%;background:#333;opacity:0.6;filter:alpha(opacity=60);z-index:9999999999;position:fixed;top:0;left:0;';
    ...
    createDialogBox : function(){
        ...
        dialogBox.style.cssText = 'margin:0;padding:0;border:none;z-index:10000000000;';
    ...
    createDialogWrap : function( tmpl ){
        ...
        var dg = new Dialog();
        var options = dg.getOptions( arguments[0] || {} );
        if(options.width){
...
//				overlay.style.display = 'none';
        ...
        if( dialogYesBtn ){
            event.bind(dialogYesBtn, 'click', function (event) {
                ...
                if (content) {
                    //如果有content输入框，则必须输入信息，并且不允许为0或者空字符串
                    if (!content.value) {
                        content.focus();
                        return;
                    }
